...
class EntertainmentNewsPageList extends StatefulWidget {
  static const id = 'EntPage';
  final countryName;

  EntertainmentNewsPageList({this.countryName});

  @override
  _EntertainmentNewsPageListState createState() =>
      _EntertainmentNewsPageListState();
}

class _EntertainmentNewsPageListState extends State<EntertainmentNewsPageList> {
  var checkLoad = true;
  Future<NewsModel> getHeadlineData;
  var headlinesData;
  Future<NewsModel> entertainmentData;
  List newsJson = [];
  ...
  Widget build(BuildContext context) {
    setState(() {
      ...
      entertainmentData = headlinesData.getEntPost(
        widget.countryName,
      );
    });
...
class EnTTileList extends StatelessWidget {
  EnTTileList({
