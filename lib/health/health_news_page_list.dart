...
class HealthNewsPageList extends StatefulWidget {
  static const id = 'HealthNewsPageList';
  final countryName;

  HealthNewsPageList({this.countryName});

  @override
  _HealthNewsPageListState createState() => _HealthNewsPageListState();
}

class _HealthNewsPageListState extends State<HealthNewsPageList> {
  var checkLoad = true;
  Future<NewsModel> getHeadlineData;
  var headlinesData;
  List newsJson = [];
  List newsJsonHeadline = [];
  Future<NewsModel> healthData;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    setState(() {
      ...
      healthData = headlinesData.getHealthPost(
        widget.countryName,
      );
    });
      ...
      child: ListView(shrinkWrap: true, children: [
        Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('On Today\'s Health Matters',
                  style: TextStyle(
                      fontFamily: 'Lobster',
                      fontWeight: FontWeight.bold,
                      fontSize:
...
class HealthTileList extends StatelessWidget {
  HealthTileList({
