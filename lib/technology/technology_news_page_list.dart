...
class TechNewsPageList extends StatefulWidget {
  static const id = 'TechNewsPageList';
  final countryName;

  TechNewsPageList({this.countryName});

  @override
  _TechNewsPageListState createState() => _TechNewsPageListState();
}

class _TechNewsPageListState extends State<TechNewsPageList> {
  var checkLoad = true;
  ...
  Widget build(BuildContext context) {
    setState(() {
      ...
      techData = headlinesData.getTechPost(
        widget.countryName,
      );
    });
...
class TechTileList extends StatelessWidget {
  TechTileList({
